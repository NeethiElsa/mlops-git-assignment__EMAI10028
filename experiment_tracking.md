...
| EXP-03| Decision Tree classifier    | default| No Scaling | All features selected except year.| 80/20| 0.83 | 0.93 | 
| EXP-04| Decision Tree classifier    | default| Done(Removing the NA values,Scaling) | All| 80/20| 0.83 | 0.04| 